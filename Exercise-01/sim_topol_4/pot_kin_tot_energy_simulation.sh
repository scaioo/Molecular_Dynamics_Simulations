...
gmx grompp -f em.mdp -p topol_${TOPO_NUM}.top -c intro.gro -o em_${TOPO_NUM}.tpr -maxwarn 5
gmx mdrun -v -deffnm em_${TOPO_NUM}

# Step 2: NVT/short simulation
gmx grompp -f intro_${STEP_NUM}.mdp -p topol_${TOPO_NUM}.top -c em_${TOPO_NUM}.gro -o intro_${STEP_NUM}_${TOPO_NUM}.tpr -maxwarn 5
